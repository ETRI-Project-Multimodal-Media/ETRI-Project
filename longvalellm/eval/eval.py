...
questions = {
    ...
    'sample_captioning': ['Could you please detail the events that took place during different time segments in the video? List the events in the json format including start_time, end_time, visual, audio, speech information, actors \n  ...']
} 
